    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          {/* Section header */}
          <div className="max-w-3xl mx-auto pb-12 md:pb-16" data-aos-id-testimonialcar>
          <small className="text-caps"> / TESTIMONIAL</small>
            <h2 className="h2 mb-4 weight-thin pt-12" data-aos="fade-up" data-aos-anchor="[data-aos-id-testimonialcar]">What People are saying about us.</h2>
          </div>
