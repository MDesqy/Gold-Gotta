      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="w-full mx-auto pb-12 md:pb-20">
            <small className="text-caps"> / CO-FOUNDERS & TEAM</small>
            <h2 className="h2 pt-12 mb-4 weight-thin">Our passionate team</h2>
          </div>
          ...
          >
            ...
            >
              <div className="flex flex-col items-center">
                <img
                  ...
                  alt="Team member 01"
                />
                <h4 className="text-xl font-medium mb-1">Siapa ya?</h4>
            ...
            >
              <div className="flex flex-col items-center">
                ...
                />
                <h4 className="text-xl font-medium mb-1">Siapa ya?</h4>
                <div className="text-gray-500 mb-1">Co-founder & Head of Design</div>
                <a
                  className="block text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
                  href="#0"
                >
            ...
            >
              <div className="flex flex-col items-center">
                ...
                />
                <h4 className="text-xl font-medium mb-1">Siapa ya?</h4>
                <div className="text-gray-500 mb-1">Co-founder & Product Executive</div>
                <a
                  className="block text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
                  href="#0"
                >
            ...
            >
              <div className="flex flex-col items-center">
                ...
                />
                <h4 className="text-xl font-medium mb-1">Siapa ya?</h4>
                <div className="text-gray-500 mb-1">Co-founder & Head of Mobile Development</div>
                <a
                  className="block text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
                  href="#0"
                >
            ...
            >
              <div className="flex flex-col items-center">
                ...
                />
                <h4 className="text-xl font-medium mb-1">Siapa ya?</h4>
                <div className="text-gray-500 mb-1">Co-founder & Backend Lead</div>
                <a
                  className="block text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out"
                  href="#0"
                >
